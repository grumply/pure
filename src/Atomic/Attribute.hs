...
pattern Comma <- (keyCode -> Just 188)
pattern Period <- (keyCode -> Just 190)
pattern Semicolon <- (keyCode -> Just 186)
pattern Quote <- (keyCode -> Just 222)
pattern BracketLeft <- (keyCode -> Just 219)
pattern BracketRight <- (keyCode -> Just 221)
pattern Backslash <- (keyCode -> Just 220)
pattern Minus <- (keyCode -> Just 189)
pattern Equal <- (keyCode -> Just 187)
pattern IntlRo <- (keyCode -> Just 193)
pattern IntlYen <- (keyCode -> Just 255)
