{-# LANGUAGE CPP, RecordWildCards, OverloadedStrings, LambdaCase, BangPatterns, PatternSynonyms, ScopedTypeVariables, FlexibleContexts #-}
module Server where
          ...
          def
              ...
              , render = \s ServerState {..} ->
                  Keyed (SimpleHTML "clients") <||#>
                    fmap (fmap (Server.connection s)) (IntMap.toAscList ssConnections)
              }
