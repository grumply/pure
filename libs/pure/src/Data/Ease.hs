module Data.Ease where

-- Easings take a total duration and an elapsed duration and returns a scalar
-- for muliplying against the desired total change. For bounded easings, this
